...
plot(gaussian.ll.v(mean = seq(from = -10, to = 10, by = 8/20), var = 1, data = x)) # Plot the log-likelihood function 
```

The approximate value of the mean that maximizes the log-likelihood function is 25. This makes sense given how we generated the sample using rnorm(). 
